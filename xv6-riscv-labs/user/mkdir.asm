...
free(void *ap)
{
 ...
 6bc:	2287b783          	ld	a5,552(a5) # 8e0 <freep>
 ...
 6c8:	00e6ea63          	bltu	a3,a4,6dc <free+0x30>
{
 ...
 70a:	1cf73d23          	sd	a5,474(a4) # 8e0 <freep>
}
 70e:	60a2                	ld	ra,8(sp)
 710:	6402                	ld	s0,0(sp)
...
malloc(uint nbytes)
{
 ...
 754:	19053503          	ld	a0,400(a0) # 8e0 <freep>
 ...
 780:	16448493          	addi	s1,s1,356 # 8e0 <freep>
  if(p == (char*)-1)
 784:	5afd                	li	s5,-1
 ...
 794:	15878793          	addi	a5,a5,344 # 8e8 <base>
 798:	00000717          	auipc	a4,0x0
 79c:	14f73423          	sd	a5,328(a4) # 8e0 <freep>
 7a0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
