...
int main(int argc, char *argv[])
{
   ...
   c:	8d878793          	addi	a5,a5,-1832 # 8e0 <malloc+0xfc>
  ...
  62:	88250513          	addi	a0,a0,-1918 # 8e0 <malloc+0xfc>
  ...
  9c:	86058593          	addi	a1,a1,-1952 # 8f8 <malloc+0x114>
  ...
  b2:	85a58593          	addi	a1,a1,-1958 # 908 <malloc+0x124>
  ...
  c8:	85458593          	addi	a1,a1,-1964 # 918 <malloc+0x134>
  ...
  de:	84e58593          	addi	a1,a1,-1970 # 928 <malloc+0x144>
  ...
  f4:	84858593          	addi	a1,a1,-1976 # 938 <malloc+0x154>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ac:	50080813          	addi	a6,a6,1280 # 9a8 <digits>
 4b0:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5a8:	3ac70713          	addi	a4,a4,940 # 950 <malloc+0x16c>
 ...
 636:	376b8b93          	addi	s7,s7,886 # 9a8 <digits>
 ...
 68c:	2c090913          	addi	s2,s2,704 # 948 <malloc+0x164>
        while(*s != 0){
...
free(void *ap)
{
 ...
 76e:	2567b783          	ld	a5,598(a5) # 9c0 <freep>
 ...
 77a:	00e6ea63          	bltu	a3,a4,78e <free+0x30>
{
 ...
 7bc:	20f73423          	sd	a5,520(a4) # 9c0 <freep>
}
 7c0:	60a2                	ld	ra,8(sp)
 7c2:	6402                	ld	s0,0(sp)
...
malloc(uint nbytes)
{
 ...
 806:	1be53503          	ld	a0,446(a0) # 9c0 <freep>
 ...
 832:	19248493          	addi	s1,s1,402 # 9c0 <freep>
  if(p == (char*)-1)
 836:	5afd                	li	s5,-1
 ...
 846:	18678793          	addi	a5,a5,390 # 9c8 <base>
 84a:	00000717          	auipc	a4,0x0
 84e:	16f73b23          	sd	a5,374(a4) # 9c0 <freep>
 852:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8c0:	10a73223          	sd	a0,260(a4) # 9c0 <freep>
      return (void*)(p + 1);
